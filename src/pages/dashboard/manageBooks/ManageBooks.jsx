  ...
  return (
    <section className='py-1 bg-blueGray-50'>
      <div className='w-full xl:w-8/12 mb-12 xl:mb-0 px-4 mx-auto mt-24'>
        <div
          className='relative flex flex-col min-w-0 wrap-break-word
          ...
          <div className='block w-full overflow-x-auto'>
            <table className='items-center bg-transparent w-full border-collapse '>
              <thead>
                <tr>
                  <th
                    className='px-6 bg-blueGray-50 text-blueGray-500 align-middle border
                ...
                {books &&
                  books.map((book, index) => (
                    <tr key={index}>
                      ...
                      <td
                        className='border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs
                       whitespace-nowrap p-4 space-x-4'
                      >
                        <Link
                          to={`/dashboard/edit-book/${book._id}`}
                          className='font-medium text-indigo-600 hover:text-indigo-700 mr-2
