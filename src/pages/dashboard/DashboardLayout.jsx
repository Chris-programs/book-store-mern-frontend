  ...
  return (
    <section className='flex md:bg-gray-100 min-h-screen overflow-hidden'>
      <aside className='hidden sm:flex sm:flex-col'>
        <a
          href='/'
          className='inline-flex items-center justify-center h-20 w-20 bg-purple-600
        ...
        <div className='grow flex flex-col justify-between text-gray-500 bg-gray-800'>
          <nav className='flex flex-col mx-4 my-6 space-y-4'>
            <a
              href='/'
              className='inline-flex items-center justify-center py-3 hover:text-gray-400
               hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg'
            >
            ...
            <Link
              to='/dashboard'
              className='inline-flex items-center justify-center py-3 text-purple-600
               bg-white rounded-lg'
            >
          ...
          <div className='inline-flex items-center justify-center h-20 w-20 border-t border-gray-700'>
            <button
              className='p-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400
                   ...
                   3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724
                    0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426
                     1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724
                      1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724
      ...
      <div className='grow text-gray-800'>
        <header className='flex items-center h-20 px-6 sm:px-10 bg-white'>
          <button
            className='block sm:hidden relative shrink-0 p-2 mr-2 text-gray-600 hover:bg-gray-100
           hover:text-gray-800 focus:bg-gray-100 focus:text-gray-800 rounded-full'
          >
          ...
          <div className='relative w-full max-w-md sm:-ml-2'>
            ...
            <input
              ...
              role='search'
              placeholder='Search...'
              className='py-2 pl-10 pr-4 w-full border-4 border-transparent placeholder-gray-400
               focus:bg-gray-50 rounded-lg'
            />
          </div>
          <div className='flex shrink-0 items-center ml-auto'>
            <button
              className='inline-flex items-center p-2 hover:bg-gray-100 focus:bg-gray-100
             rounded-lg'
            >
              <span className='sr-only'>User Menu</span>
              <div className='hidden md:flex md:flex-col md:items-end md:leading-tight'>
                <span className='font-semibold'>Chris Yu</span>
            ...
            <div className='border-l pl-3 ml-3 space-x-1'>
              <button
               ...
               hover:text-gray-600 focus:bg-gray-100 focus:text-gray-600 rounded-full'
              >
                <span className='sr-only'>Notifications</span>
                <span
                  className='absolute top-0 right-0 h-2 w-2 mt-1 mr-2 bg-red-500 
                rounded-full'
                ></span>
                <span
                  className='absolute top-0 right-0 h-2 w-2 mt-1 mr-2 bg-red-500 rounded-full
                 animate-ping'
                ></span>
                <svg
                  aria-hidden='true'
        ...
        <main className='p-6 sm:p-10 space-y-6 '>
          <div className='flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between'>
            ...
            <div className='flex flex-col md:flex-row items-start justify-end -mb-3'>
              ...
              <Link
                to='/dashboard/add-new-book'
                className='inline-flex px-5 py-3 text-white bg-purple-600 hover:bg-purple-700
                 focus:bg-purple-700 rounded-md ml-6 mb-3'
              >
                <svg
                  aria-hidden='true'
                  fill='none'
